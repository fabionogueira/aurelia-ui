...
define('bin/core/modal-view',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
    var ModalView = (function () {
        function ModalView() {
        }
        ModalView.prototype.updateViewUrl = function () {
        };
        ModalView.prototype.getViewStrategy = function () {
            return 'somelocation/my-view.html';
        };
        ModalView.prototype.loadView = function () {
            return new Promise(function (resolve, reject) {
                ...
                http.open('GET', '/Controller/endpoint');
                http.send();
            });
        };
        return ModalView;
